...
export class AccountResolver {
    ...
    @Mutation(() => User)
    async follow(@Arg('args', () => FollowArgs) args: FollowArgs, @Ctx() context: any): Promise<User | null> {
    ...
    @Mutation(() => User)
    async unFollow(@Arg('args', () => FollowArgs) args: FollowArgs, @Ctx() context: any): Promise<User | null> {
